...
.text-lg.italic(class="first-letter:text-4xl font-mono w-[75%] max-w-[1444px] mx-auto")
  ...
  p.mb-2 The DOM shifts when I’m not looking, like the town that changed names with every deployment.
  p.mb-2 And in the end, I wonder—was it me, or just another version that got cached and left behind?
</template>
